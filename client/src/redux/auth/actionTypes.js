...
export const POST_LOGOUT_REQUESTs = "POST_LOGOUT_REQUEST";
export const POST_LOGOUT_SUCCESSs = "POST_LOGOUT_SUCCESS";
export const POST_LOGOUT_FAILUREs = "POST_LOGOUT_FAILURE";
